...
import ImportedBabelTransform from '@babel/core/transform';
import ImportedBabelStore2 from 'babel-core/store';
...
// should only apply the alias once
// @babel/core/transform should becore @babel/core/lib/transform, not @babel/core/lib/lib/transform
export { ExportedBabelTransform } from '@babel/core/transform';
export { ExportedBabelStore2 } from 'babel-core/store';
