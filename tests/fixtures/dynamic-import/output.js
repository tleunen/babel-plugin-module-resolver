...
import('../../testproject/src/components/Header/SubHeader')
  .then(() => {})
  .catch(() => {}); // should alias the path

import('../../testproject/test')
  .then(() => {})
  .catch(() => {}); // should not change a relative path

import('./utils')
  .then(() => {})
  .catch(() => {}); // should handle the first argument not being a string literal

import(path)
  .then(() => {})
  .catch(() => {}); // should handle an empty path
